...
public class Schedule implements Serializable {
	...
	public void addSeance(Seance seance) throws FailTimeException {
		...
		seances.add(seance);
		System.out.println("Seance is successfully added to schedual");
	}
	...
	public void removeSeance(Movie movie) throws FailTimeException {
		...
		if (removingSeanceFound.isPresent()) {
			...
			System.out.println("Seance is successfully deleted from schedual");
		} else {
			System.out.println("There is no such seance is schedual");
		}
	}
